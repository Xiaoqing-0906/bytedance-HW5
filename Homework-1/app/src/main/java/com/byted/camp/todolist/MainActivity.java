...
//                        .setAction("Action", null).show();
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                note.setState(State.Companion.from(intState));
                note.setPriority(Priority.Companion.from(intPriority));
    ...
    private void updateNode(Note note) {
        ...
        values.put(TodoNote.COLUMN_STATE, note.getState().getIntValue());
